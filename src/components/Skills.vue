...
.icon--javascript {
    background: url(../assets/img/icons/js.svg);
}

.icon--typescript {
    background: url(../assets/img/icons/ts.svg);
}

.icon--php {
    background: url(../assets/img/icons/php.svg);
}

.icon--nodejs {
    background: url(../assets/img/icons/nodejs.svg);
}

.icon--java {
    background: url(../assets/img/icons/java.svg);
}

.icon--mysql {
    background: url(../assets/img/icons/mysql.svg);
}

.icon--sqlserver {
    background: url(../assets/img/icons/sqlserver.svg);
}

.icon--laravel {
    background: url(../assets/img/icons/laravel.svg);
}

.icon--vuejs {
    background: url(../assets/img/icons/vuejs.svg);
}

.icon--express {
    background: url(../assets/img/icons/express.svg);
}
</style>